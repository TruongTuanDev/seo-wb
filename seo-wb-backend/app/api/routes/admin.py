...
def _settings_response(row: AdminAiSettings, settings: Settings) -> AdminAiSettingsResponse:
    return AdminAiSettingsResponse(
        ...
        seo_engine_enabled=row.seo_engine_enabled,
        seo_min_score=row.seo_min_score,
        description_min_chars=row.description_min_chars,
        description_max_chars=row.description_max_chars,
        seo_repair_max_attempts=row.seo_repair_max_attempts,
        require_primary_keyword_in_title=row.require_primary_keyword_in_title,
        warn_low_confidence_attributes=row.warn_low_confidence_attributes,
        enable_russian_grammar_validation=row.enable_russian_grammar_validation,
        enable_keyword_stuffing_detection=row.enable_keyword_stuffing_detection,
        enable_subject_title_templates=row.enable_subject_title_templates,
        include_gender_in_title=row.include_gender_in_title,
        minimum_grammar_score=row.minimum_grammar_score,
        minimum_marketplace_score=row.minimum_marketplace_score,
        minimum_critical_attribute_score=row.minimum_critical_attribute_score,
