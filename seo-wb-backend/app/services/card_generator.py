...
SYSTEM_PROMPT = (
    "Ты эксперт по созданию карточек товара Wildberries. Верни только валидный JSON без markdown. "
    "Формат: массив объектов {subjectID, variants}. Каждый variant содержит vendorCode, title, description, "
    "brand, dimensions, characteristics, sizes. Пиши title и description на русском языке. "
    ...
    "Размеры S-42 означают techSize=S и wbSize=42. Одинарный размер S означает techSize=S и wbSize=S. "
