...
def test_gpt_prompt_builder():
    ...
    assert "Frame primarily from the upper abdomen or shirt-hem level to the shoes." in focused_prompt
    ...
    assert "45-degree side upper-abdomen-to-shoes product-focused crop" in side_crop_prompt
    ...
    assert "upper-abdomen-to-shoes product-focused crop" in front_crop_prompt
    assert "visible space above the waistband" in front_crop_prompt
